...
for i = 1:size(subfolders,1)
        ...
        firstlevel_DIR= strcat(SUB_DIR,'1stLevel_MOTOR_Ftest'); %motor specific
    ...
    %Condition2- MOTOR - Feet
    matlabbatch{1}.spm.stats.fmri_spec.sess.cond(2).name = 'motor_feet';
                   
    matlabbatch{1}.spm.stats.fmri_spec.sess.cond(2).onset = feet.Var1; %onsets
    matlabbatch{1}.spm.stats.fmri_spec.sess.cond(2).duration = feet.Var2; %durations

    matlabbatch{1}.spm.stats.fmri_spec.sess.cond(2).tmod = 0;
    matlabbatch{1}.spm.stats.fmri_spec.sess.cond(2).pmod = struct('name', {}, 'param', {}, 'poly', {});
    matlabbatch{1}.spm.stats.fmri_spec.sess.cond(2).orth = 1;

    %Condition2- MOTOR - TONGUE
    matlabbatch{1}.spm.stats.fmri_spec.sess.cond(3).name = 'motor_tongue';
                   
    matlabbatch{1}.spm.stats.fmri_spec.sess.cond(3).onset = tongue.Var1; %onsets
    matlabbatch{1}.spm.stats.fmri_spec.sess.cond(3).duration = tongue.Var2; %durations
    ...
    %Condition2- CUE
    matlabbatch{1}.spm.stats.fmri_spec.sess.cond(4).name = 'motor_hand';
                   
    matlabbatch{1}.spm.stats.fmri_spec.sess.cond(4).onset = hand.Var1; %onsets
    matlabbatch{1}.spm.stats.fmri_spec.sess.cond(4).duration = hand.Var2; %durations
    ...
    %% Define Contrasts
    matlabbatch{3}.spm.stats.con.consess{1}.fcon.name = 'Motor - Ftest'; % Contrast name
    matlabbatch{3}.spm.stats.con.consess{1}.fcon.weights = [1 1 1 0]; % Set contrast
