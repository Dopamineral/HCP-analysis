...
for i = 1:size(subfolders,1)
        ...
        firstlevel_DIR= strcat(SUB_DIR,'1stLevel_MOTOR_foot'); %motor specific
    ...
    %Condition2- CUE
    matlabbatch{1}.spm.stats.fmri_spec.sess.cond(2).name = 'motor_foot';
                   
    matlabbatch{1}.spm.stats.fmri_spec.sess.cond(2).onset = foot.Var1; %onsets
    matlabbatch{1}.spm.stats.fmri_spec.sess.cond(2).duration = foot.Var2; %durations
    ...
    %% Define Contrasts
    matlabbatch{3}.spm.stats.con.consess{1}.tcon.name = 'Cue-MotorFoot-01'; % Contrast name
