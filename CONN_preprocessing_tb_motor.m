...
cwd=pwd;
FUNCTIONAL_FILE=cellstr(conn_dir('sub-*\func\sub-*_tfMRI_MOTOR_LR.nii')); %the first asterix doesn't work here for some reason.
...
clear batch;
batch.filename=fullfile(DATA_DIR,'tb_motor.mat');            % Existing conn_*.mat experiment name
