...
% Adapted version of Andysbrainbook conn processing script.
...
cwd=pwd;
FUNCTIONAL_FILE=cellstr(conn_dir('sub-*\func\sub-*_tfMRI_LANGUAGE_LR.nii')); %the first asterix doesn't work here for some reason.
...
batch.filename=fullfile(DATA_DIR,'tb_langauge.mat');            % New conn_*.mat experiment name
...
clear batch;
batch.filename=fullfile(cwd,'DATA_DIR','tb_langauge.mat');            % Existing conn_*.mat experiment name
